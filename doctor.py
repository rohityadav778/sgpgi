...
<body onload="slide()" bgcolor="black">
	...
	<ul>
		...
		<div class="outer">
	 <div class="r">
	  <h2><b>WELCOME TO DOCTOR REGISTRATION</h2>
	 </div>
   	   <div class="form">
   	    <div class="formbox">
        <form action="doctorcode.py" method="post" style="margin-left:100px;margin-top:50px;">
          <span> Name</span></br>
          ...
          <span>Gender &nbsp &nbsp
           ...
           <select name="timing">
              ...
              <option>7:00am-12:00pm</option>
           	   <option>12:00pm-5:00pm</option>
           	   <option>5:00pm-10:00pm</option>
           	</select>
            <br/><br/>
...
print " = <input type='number' name='t' style='width:60px;' required />"
print "</td>"
print """    
<br/>
<br/>
             <div>
			 <a href="login.py"><input style="background-color:#fff;height:40px;width:130px;" type="submit"/></a><br/>
