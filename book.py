...
<div id="main">
	...
	<img src="images/pgilogo.png" style="width:120px;height:80px;">
	   ...
	   <h1>Welcome To Patient Profile <br/> &nbsp &nbsp Book Appointment</h1>
	   <form action="bookcode.py" method="post">

<center><select name="spec" style="height:35px; width:300px; margin-left:220px;background-color:#0001; color:#fff;">
...
<br/>
<input style="height:40px; width:200px; margin-left:235px;background-color:#0001; color:#fff;" type="submit" value="Search Docter"/>
</form>
</center>
</div>
<div class="middle">
