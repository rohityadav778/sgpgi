...
<div id="main">
   ...
   <form action="doctorchangepasscode.py" method="post">
   <table style="font-size:30px; color:#fff;width:700px;">
   <tr>
      <td>Enter Email Id :</td>
       <td>
	      <input style="font-size:20px; color:#000;width:220px; height:25px;" type="email" name="email" required placeholder="Enter Your Email" />
	   </td>
   </tr>
   <tr>
      <td>Enter Old Password :</td>
       <td>
	      <input style="font-size:20px; color:#000;width:220px; height:25px;" type="password" name="oldpass" required placeholder="Enter Old Password" />
	   </td>
   </tr>
    <tr>
      <td>Enter New Password :</td>
       <td>
	      <input style="font-size:20px; color:#000;width:220px; height:25px;" type="password" name="newpass" required placeholder="Enter New Password"/>
	   </td>
   </tr>
    <tr>
      <td>Enter Confirm Password :</td>
       <td>
	      <input style="font-size:20px; color:#000;width:220px; height:25px;" type="password" name="cpass" required placeholder="Enter Confirm Password"/>
	   </td>
   </tr>
    <tr>
      <td colspan="2" align="">
	  <input style="margin-left:250px;margin-top:30px;height:40px;width:150px; background-color:#2da5ca;color:#fff;transform:scale(1.1);" type="submit" value="Change Password"/>
	   </td>
   </tr>
   </table>
   </form>
