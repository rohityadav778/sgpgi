...
//background-image:url(images/pngtree.jpg);
   //background-color:#0009;
       ...
       //background-image:linear-gradient(rgba(0.0,0,0.0,0.5),rgba(0.0,0,0.0,0.5)),url(images/s1.jpg);
	   margin-left:400px;
	   }
	   #mainslider
	   {
...
<form action="updatelogcode.py" method="post">
 <div id="mainslider">
     <center><div id="outer">
      <br/>
      <br/>
     ...
     <img style="height:100px; width:100px; " src="images/login.png"/>
	 <br/>
	  <br/>
    <br/>
	 <select  style="height:40px; width:400px; background-color:#0002;color:#fff;" name="login" required >
    ...
    <br/>
    <br/>
    	<input style="height:40px; width:400px; background-color:#0002;" type="email" name="email"   placeholder="Username" required />
     <br/>
     <br/>
       <input style="height:40px; width:400px; background-color:#0002;color:#fff;" type="password"  name="password" placeholder="Password" required />
       <br/>
       <input type="checkbox"/><span style="padding-right:110px;">Remember me</span>
       <a href="#">Forgot password?<a/>
       <br/>
       <br/>
       <br/>
       <input style="height:40px; width:250px; background-color:lightblue;" type="submit" value="LOGIN"/>
	 </div>
	  </center>
	  </form>
	  <h1 style="color:#2da5ca;margin-left:140px;position:relative;bottom:490px;font-weight:bold;">FIRST LOGIN HERE</h1>
	  </div>  
	  <!---------slider end here ---->
<div class="middle">
		     <h1>OUR BEST <span style="color:#2da5ca;">SERVICES<span></h1>
			<p style="color:black;text-decoration:none;">SGPGIMS is a great hospital in lucknow it has many branch
...
<div class="footer">
  ...
  <div id="Copyright">
<p> &copy copyright 2019 Allright Reserved By SGPGI /Designed by Rohit Yadav</p></center> 
</div>
</body>
</html>
"""